...
5. `t()` - 80 edges
6. `B()` - 80 edges
7. `Communities (93 total, 9 thin omitted)` - 77 edges
8. `w()` - 71 edges
9. `y()` - 71 edges
10. `tc()` - 71 edges
...
- `G()` --indirect_call--> `p()`  [INFERRED]
  public/js/app.js → public/js/app.js  _Bridges community 26 → community 18_
...
### Community 3 - "Communities (93 total, 9 thin omitted)"
Cohesion: 0.03
Nodes (77): Communities (93 total, 9 thin omitted), Community 0 - "C", Community 10 - "ClojureScript y shadow-cljs", Community 11 - "l", Community 12 - "ARCHITECTURE", Community 13 - "Universo - Plataforma de Evaluación Adaptativa", Community 14 - "Producto y negocio", Community 16 - "v" (+69 more)
...
### Community 5 - ".then"
Cohesion: 0.13
Nodes (32): Af(), Cf(), de(), df(), E(), ee(), eq(), fk() (+24 more)

### Community 6 - "app.js"
Cohesion: 0.05
Nodes (167): ad(), ag(), Ah(), aI(), aL(), ap(), ar(), B() (+159 more)
...
### Community 9 - "C"
Cohesion: 0.08
Nodes (14): aj(), C(), ci(), Gc(), he(), Ic(), kn(), lf() (+6 more)
...
### Community 15 - "K"
Cohesion: 0.04
Nodes (10): ak(), Bc(), bk(), cc(), ia(), ib(), K(), oo() (+2 more)

### Community 16 - "v"
Cohesion: 0.07
Nodes (6): ba(), CJ(), Ep(), Ga(), v(), z()

### Community 18 - "kf"
Cohesion: 0.07
Nodes (20): ca(), da(), eb(), eo(), handler(), Ja(), kf(), La() (+12 more)
...
### Community 22 - "ab"
Cohesion: 0.16
Nodes (6): ab(), jb(), mathmlBuilder(), oa(), uc(), Xb()

### Community 23 - "x"
Cohesion: 0.10
Nodes (30): Bb(), Bd(), cb(), ce(), ef(), ff(), Hd(), hf() (+22 more)
...
### Community 25 - "na"
Cohesion: 0.13
Nodes (28): an(), bn(), Cm(), Dm(), dn(), Em(), en(), fd() (+20 more)
...
### Community 45 - "J"
Cohesion: 0.10
Nodes (23): ac(), Ch(), dc(), di(), ec(), fc(), gf(), hc() (+15 more)
...
### Community 80 - "wf"
Cohesion: 0.16
Nodes (7): Fa(), fb(), Nc(), S(), Wa(), wf(), Xe()

### Community 81 - "sa"
Cohesion: 0.16
Nodes (13): Ao(), Dd(), Dh(), Go(), Ho(), Io(), Jo(), Ko() (+5 more)
...
### Community 86 - "Zb"
Cohesion: 0.09
Nodes (15): dg(), jg(), ma(), Of(), rc(), Si(), sm(), Ti() (+7 more)
...
## Knowledge Gaps
- **737 isolated node(s):** `autoprefixer`, `postcss`, `shadow-cljs`, `tailwindcss`, `@supabase/supabase-js` (+732 more)
...
- **Why does `v()` connect `v` to `.then`, `app.js`, `t`, `C`, `K`, `kf`, `x`, `na`, `G`, `N`, `I`, `A`, `J`, `be`, `ae`, `wf`, `sa`, `Zb`, `D`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `K()` connect `K` to `.then`, `app.js`, `C`, `v`, `u`, `kf`, `x`, `na`, `G`, `ya`, `mb`, `I`, `jc`, `A`, `J`, `be`, `w`, `wf`, `Zb`, `D`?**
