...
## Corpus Check
- 174 files · ~895,970 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3060 nodes · 7387 edges · 214 communities (184 shown, 30 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 781 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af8709bc`
...
1. `v()` - 241 edges
2. `Communities (206 total, 24 thin omitted)` - 147 edges
3. `H()` - 141 edges
4. `K()` - 137 edges
5. `C()` - 130 edges
6. `w()` - 124 edges
...
- `K()` --indirect_call--> `Ka()`  [INFERRED]
  public/js/app.js → public/js/app.js  _Bridges community 153 → community 135_
- `K()` --indirect_call--> `Rj()`  [INFERRED]
  public/js/app.js → public/js/app.js  _Bridges community 153 → community 197_
- `K()` --indirect_call--> `ua()`  [INFERRED]
  public/js/app.js → public/js/app.js  _Bridges community 153 → community 189_
- `K()` --indirect_call--> `y()`  [INFERRED]
  public/js/app.js → public/js/app.js  _Bridges community 153 → community 104_
- `K()` --indirect_call--> `z()`  [INFERRED]
  public/js/app.js → public/js/app.js  _Bridges community 153 → community 159_
...
Cohesion: 0.04
Nodes (48): Contradicciones detectadas (regla de gobernanza 14), Dominio (IRT y contenido), La cuarta opción: Google Workspace del establecimiento (agregada 2026-08-16), OPEN_QUESTIONS, Preguntas respondidas, Proceso, Producto y negocio, ✅ Q-01 · ¿Cuál es el vínculo formal con la UNAP? (+40 more)
...
Cohesion: 0.10
Nodes (21): T-05 · Router de URL con history API — **P1** · `hecho` (2026-08-16, rama `t-05-router-url`, sin mergear), T-100 · Migrar el diagnóstico y «Mi plan» al lenguaje del panel — **P1** · `abierto`, T-101 · Mapa de prerrequisitos visible y manipulable — **P2** · `abierto`, T-102 · Editor de recursos: edición en la fila y Markdown básico — **P2** · `abierto`, T-24 · Estado vacío honesto en "Mi plan" y "Cupos" — **P1** · `hecho` (2026-08-03, mergeado a `main` 2026-08-05), T-25 · Comunicar el estado del cupo pendiente y cancelarlo si no alcanza el mínimo — **P1** · `hecho` (2026-07-30, sin verificar en vivo), T-26 · Semántica del re-diagnóstico — **P2** · `bloqueado` (decisión Q-07), T-36 · Preferencia de canal de contacto (email / notificación / WhatsApp) — **P2** · `hecho` (2026-07-30, sin verificar en vivo) (+13 more)
...
### Community 104 - "H"
Cohesion: 0.19
Nodes (54): ad(), ag(), ai(), aQ(), Bg(), cg(), DJ(), dq() (+46 more)
...
Cohesion: 0.17
Nodes (25): aa(), bb(), cb(), Cd(), dd(), Dh(), dn(), Gb() (+17 more)
...
### Community 133 - ".then"
Cohesion: 0.08
Nodes (58): af(), be(), bh(), Bm(), Ce(), Cf(), Ch(), Cm() (+50 more)
...
Cohesion: 0.25
Nodes (8): L-09 · `profiles_update_own` impide cambiar roles (UPDATE afecta 0 filas), L-10 · Un admin podía quedarse sin administradores, L-11 · `false` no puede significar dos cosas, L-12 · Las migraciones deben ser idempotentes, L-13 · El orden de las migraciones no es opcional, L-14 · La UI no es un control de acceso, L-42 · Un proveedor OAuth crea cuentas **también** en la ruta de login, Supabase, RLS y migraciones
...
### Community 151 - "Wd"
Cohesion: 0.13
Nodes (14): Ab(), ak(), Bd(), bk(), dc(), Ec(), fc(), hc() (+6 more)
...
### Community 164 - "app.js"
Cohesion: 0.07
Nodes (46): ac(), ae(), Ah(), B(), bf(), C(), cn(), dO() (+38 more)
...
### Community 169 - ".S"
Cohesion: 0.07
Nodes (59): an(), ar(), bi(), bL(), bn(), BR(), cr(), dS() (+51 more)

### Community 172 - "de"
Cohesion: 0.09
Nodes (20): db(), ek(), Gd(), jf(), ji(), kd(), Md(), Mf() (+12 more)
...
### Community 188 - "ba"
Cohesion: 0.18
Nodes (6): Dg(), jg(), Nc(), oc(), Sb(), va()

### Community 189 - ".expandOnce"
Cohesion: 0.09
Nodes (5): D(), G(), ia(), ta(), ua()
...
### Community 192 - "xc"
Cohesion: 0.20
Nodes (12): Gc(), hf(), If(), Jb(), Ld(), ma(), rc(), Rd() (+4 more)
...
### Community 197 - "m"
Cohesion: 0.04
Nodes (75): aj(), aL(), AM(), ap(), bj(), bp(), ci(), CJ() (+67 more)

### Community 198 - "handler"
Cohesion: 0.25
Nodes (5): Ca(), eo(), handler(), xa(), ya()
...
### Community 206 - "Xd"
Cohesion: 0.26
Nodes (12): eb(), ib(), lf(), mathmlBuilder(), Rb(), Rf(), Si(), Ti() (+4 more)

### Community 207 - "l"
Cohesion: 0.14
Nodes (6): htmlBuilder(), Ja(), l(), Na(), qa(), Ra()
...
## Knowledge Gaps
- **1664 isolated node(s):** `autoprefixer`, `postcss`, `shadow-cljs`, `tailwindcss`, `@supabase/supabase-js` (+1659 more)
...
- **Why does `BUSINESS_CONTEXT` connect `BUSINESS_CONTEXT` to `BACKLOG.md`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `OPEN_QUESTIONS` connect `Producto y negocio` to `BACKLOG.md`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `BACKLOG` connect `BACKLOG` to `Épica E2 — Endurecimiento (F9)`, `Épica E1 — Go-live real (F8)`, `Épica E3 — Deuda técnica y limpieza`, `BACKLOG.md`, `Épica E4 — Producto y experiencia`, `Épica E5 — Contenido y calidad pedagógica`, `Épica E8 — Motor de valor: los cinco vectores (F12–F16)`, `Épica E7 — Memoria del proyecto (PMF)`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
...
- **Are the 22 inferred relationships involving `H()` (e.g. with `Bg()` and `dc()`) actually correct?**
  _`H()` has 22 INFERRED edges - model-reasoned connections that need verification._
- **Are the 7 inferred relationships involving `K()` (e.g. with `Ka()` and `.V()`) actually correct?**
