...
## Summary
- 2941 nodes · 7332 edges · 204 communities (176 shown, 28 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 830 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1fd5e4cc`
...
1. `v()` - 229 edges
2. `C()` - 138 edges
3. `Communities (199 total, 30 thin omitted)` - 137 edges
4. `K()` - 134 edges
5. `H()` - 127 edges
6. `D()` - 113 edges
7. `u()` - 105 edges
...
- `K()` --indirect_call--> `v()`  [INFERRED]
  public/js/app.js → public/js/app.js  _Bridges community 153 → community 182_
...
Cohesion: 0.01
Nodes (137): Communities (199 total, 30 thin omitted), Community 0 - "C", Community 102 - "ADR-025: Motor de valor B2B y los cinco vectores de crecimiento (G-1 … G-5)", Community 103 - "SESSION-017", Community 104 - "H", Community 105 - "SESSION-012", Community 106 - "SESSION-013", Community 107 - "Track de negocio (F12–F16) — decidido 2026-08-16" (+129 more)
...
Cohesion: 0.04
Nodes (45): Contradicciones detectadas (regla de gobernanza 14), Dominio (IRT y contenido), La cuarta opción: Google Workspace del establecimiento (agregada 2026-08-16), OPEN_QUESTIONS, Preguntas respondidas, Proceso, Producto y negocio, ✅ Q-01 · ¿Cuál es el vínculo formal con la UNAP? (+37 more)
...
Cohesion: 0.05
Nodes (38): ✅ Actualización 2026-08-17 — T-93 ejecutada: el contrato de Cpech leído, Detalle, R-01 · Bus factor = 1, R-02 · Desarrollo contra la base de producción, R-03 · Sin respaldo propio verificado, R-04 · Sin CI, R-05 · Divergencia del copy y del JSON-LD, R-06 · Datos personales de menores sin aviso de privacidad (+30 more)
...
Cohesion: 0.18
Nodes (10): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Freshness, Graph Report - .  (2026-08-17), Import Cycles, Knowledge Gaps, Suggested Questions (+2 more)
...
Cohesion: 0.15
Nodes (13): T-05 · Router de URL con history API — **P1** · `hecho` (2026-08-16, rama `t-05-router-url`, sin mergear), T-24 · Estado vacío honesto en "Mi plan" y "Cupos" — **P1** · `hecho` (2026-08-03, mergeado a `main` 2026-08-05), T-25 · Comunicar el estado del cupo pendiente y cancelarlo si no alcanza el mínimo — **P1** · `hecho` (2026-07-30, sin verificar en vivo), T-26 · Semántica del re-diagnóstico — **P2** · `bloqueado` (decisión Q-07), T-36 · Preferencia de canal de contacto (email / notificación / WhatsApp) — **P2** · `hecho` (2026-07-30, sin verificar en vivo), T-38 · Tema oscuro con toggle en la barra de navegación — **P2** · `hecho` (2026-08-05, mergeado a `main`), T-39 · Config de parada por banco y progresión por prerequisitos — **P1** · `hecho` (2026-08-08, mergeado a `main` vía PR #23), T-40 · Columna de cantidad de preguntas por test en el panel admin — **P2** · `hecho` (2026-08-08, sin verificar en vivo) (+5 more)
...
### Community 104 - "H"
Cohesion: 0.22
Nodes (59): A(), Ag(), ai(), aQ(), Bg(), Cg(), dq(), Ea() (+51 more)
...
### Community 133 - ".then"
Cohesion: 0.13
Nodes (34): Bm(), Cm(), df(), di(), eq(), fk(), Ie(), je() (+26 more)
...
### Community 137 - ".V"
Cohesion: 0.07
Nodes (60): Ah(), aj(), an(), bi(), bL(), dk(), dO(), ds() (+52 more)
...
Cohesion: 0.18
Nodes (11): L-19 · Dos productos en un repositorio diluyen el foco, L-20 · Las promesas del copy son requisitos, L-21 · Acotar las afirmaciones en datos estructurados, L-22 · El mismo texto en varios lugares divergirá — y el número de lugares **no se recuerda, se mide**, L-36 · El funnel estaba construido para el canal que nunca funcionó, L-37 · Se construyó maquinaria de cohortes para una demanda que nunca llegó, L-38 · Antes de proponer un modelo de ingreso, mirar la forma del mercado, L-39 · Un piloto sin encuadre comercial produce datos, no clientes (+3 more)

### Community 143 - "Supabase, RLS y migraciones"
Cohesion: 0.29
Nodes (7): L-09 · `profiles_update_own` impide cambiar roles (UPDATE afecta 0 filas), L-10 · Un admin podía quedarse sin administradores, L-11 · `false` no puede significar dos cosas, L-12 · Las migraciones deben ser idempotentes, L-13 · El orden de las migraciones no es opcional, L-14 · La UI no es un control de acceso, Supabase, RLS y migraciones
...
### Community 151 - "Wd"
Cohesion: 0.14
Nodes (9): ab(), Be(), ce(), ee(), Kc(), uc(), Wd(), yf() (+1 more)
...
Cohesion: 0.04
Nodes (78): Ac(), Ad(), aL(), Bd(), Bf(), cb(), cd(), Cf() (+70 more)
...
### Community 169 - ".S"
Cohesion: 0.12
Nodes (29): bn(), bp(), Co(), cp(), dp(), en(), Fd(), fo() (+21 more)

### Community 171 - "Zj"
Cohesion: 0.20
Nodes (10): ak(), ck(), Dc(), Hd(), md(), oe(), Oj(), Qi() (+2 more)
...
### Community 174 - "C"
Cohesion: 0.06
Nodes (19): ap(), ar(), B(), C(), ci(), fL(), ic(), ii() (+11 more)
...
### Community 181 - ".push"
Cohesion: 0.08
Nodes (8): G(), I(), Pm(), um(), vm(), wm(), y(), YK()

### Community 182 - "v"
Cohesion: 0.08
Nodes (42): AM(), bh(), BJ(), Ch(), CJ(), DJ(), eI(), ek() (+34 more)

### Community 183 - "cc"
Cohesion: 0.09
Nodes (6): bc(), cc(), Eb(), oa(), sb(), Zc()
...
### Community 188 - "ba"
Cohesion: 0.18
Nodes (11): Ao(), ba(), Bo(), Go(), Ho(), Io(), Jo(), Ko() (+3 more)
...
Cohesion: 0.22
Nodes (6): aa(), ca(), da(), handler(), Rc(), wa()

### Community 192 - "xc"
Cohesion: 0.12
Nodes (4): htmlBuilder(), Ka(), Na(), xc()
...
### Community 195 - "ae"
Cohesion: 0.11
Nodes (12): ae(), af(), db(), kb(), kf(), nc(), ob(), Qf() (+4 more)
...
### Community 197 - "m"
Cohesion: 0.08
Nodes (19): bb(), Ef(), Em(), hb(), m(), mathmlBuilder(), nb(), pa() (+11 more)
...
## Knowledge Gaps
- **1581 isolated node(s):** `autoprefixer`, `postcss`, `shadow-cljs`, `tailwindcss`, `@supabase/supabase-js` (+1576 more)
...
- **Why does `SESSION-029` connect `SESSION-029` to `BACKLOG.md`?**
