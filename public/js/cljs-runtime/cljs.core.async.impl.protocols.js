...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15674 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15674(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15682 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15682(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15699 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15699(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15705 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15705(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15709 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15709(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15710 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15710(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15714 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15714(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15716 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15716(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15717 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15717(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15721 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15721(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15726 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15726(b);
}
});
