...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15954 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15954(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15985 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15985(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15990 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15990(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15992 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15992(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_16000 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_16000(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_16004 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_16004(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_16006 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_16006(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_16008 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_16008(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_16009 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_16009(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_16014 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_16014(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_16019 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_16019(b);
}
});
