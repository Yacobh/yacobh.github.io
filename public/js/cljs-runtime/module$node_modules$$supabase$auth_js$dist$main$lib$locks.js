shadow$provide.module$node_modules$$supabase$auth_js$dist$main$lib$locks = function(global, require, module, exports) {
  ...
  exports.internals = {debug:!!(globalThis && (0,global.supportsLocalStorage)() && globalThis.localStorage && globalThis.localStorage.getItem("supabase.gotrue-js.locks.debug") === "true")};
  ...
  exports.navigatorLock = async function(name, acquireTimeout, fn) {
    ...
    return await Promise.resolve().then(() => globalThis.navigator.locks.request(name, acquireTimeout === 0 ? {mode:"exclusive", ifAvailable:!0} : {mode:"exclusive", signal:abortController.signal}, async lock => {
      if (lock) {
  ...
  exports.processLock = async function(name, acquireTimeout, fn) {
    ...
    _a = Promise.race([previousOperation.catch(() => null), acquireTimeout >= 0 ? new Promise((_, reject) => {
      setTimeout(() => {
