shadow$provide.module$node_modules$$supabase$auth_js$dist$main$GoTrueAdminApi = function(global, require, module, exports) {
  ...
  const fetch_1 = require("module$node_modules$$supabase$auth_js$dist$main$lib$fetch"), helpers_1 = require("module$node_modules$$supabase$auth_js$dist$main$lib$helpers"), types_1 = require("module$node_modules$$supabase$auth_js$dist$main$lib$types"), errors_1 = require("module$node_modules$$supabase$auth_js$dist$main$lib$errors");
  class GoTrueAdminApi {
    ...
    async signOut(jwt, scope = types_1.SIGN_OUT_SCOPES[0]) {
      if (0 > types_1.SIGN_OUT_SCOPES.indexOf(scope)) {
