shadow$provide.module$node_modules$$supabase$storage_js$dist$main$packages$StorageFileApi = function(global, require, module, exports) {
  ...
  class StorageFileApi {
    ...
    uploadOrUpdate(method, path, fileBody, fileOptions) {
      return __awaiter(this, void 0, void 0, function*() {
        try {
          ...
          typeof Blob !== "undefined" && fileBody instanceof Blob ? (body = new FormData(), body.append("cacheControl", options.cacheControl), metadata && body.append("metadata", this.encodeMetadata(metadata)), body.append("", fileBody)) : typeof FormData !== "undefined" && fileBody instanceof FormData ? (body = fileBody, body.append("cacheControl", options.cacheControl), metadata && body.append("metadata", this.encodeMetadata(metadata))) : (body = fileBody, headers["cache-control"] = `max-age=${options.cacheControl}`, 
          ...
          const cleanPath = this._removeEmptyFolders(path), _path = this._getFinalPath(cleanPath), res = yield this.fetch(`${this.url}/object/${_path}`, Object.assign({method, body, headers}, (options === null || options === void 0 ? 0 : options.duplex) ? {duplex:options.duplex} : {})), data = yield res.json();
    ...
    move(fromPath, toPath, options) {
      return __awaiter(this, void 0, void 0, function*() {
        try {
          return {data:yield (0,fetch_1.post)(this.fetch, `${this.url}/object/move`, {bucketId:this.bucketId, sourceKey:fromPath, destinationKey:toPath, destinationBucket:options === null || options === void 0 ? void 0 : options.destinationBucket}, {headers:this.headers}), error:null};
        } catch (error) {
          if ((0,errors_1.isStorageError)(error)) {
            return {data:null, error};
          }
    ...
    copy(fromPath, toPath, options) {
      return __awaiter(this, void 0, void 0, function*() {
        try {
          return {data:{path:(yield (0,fetch_1.post)(this.fetch, `${this.url}/object/copy`, {bucketId:this.bucketId, sourceKey:fromPath, destinationKey:toPath, destinationBucket:options === null || options === void 0 ? void 0 : options.destinationBucket}, {headers:this.headers})).Key}, error:null};
        } catch (error) {
          if ((0,errors_1.isStorageError)(error)) {
            return {data:null, error};
          }
    ...
    createSignedUrl(path, expiresIn, options) {
      return __awaiter(this, void 0, void 0, function*() {
        try {
          let _path = this._getFinalPath(path), data = yield (0,fetch_1.post)(this.fetch, `${this.url}/object/sign/${_path}`, Object.assign({expiresIn}, (options === null || options === void 0 ? 0 : options.transform) ? {transform:options.transform} : {}), {headers:this.headers});
          data = {signedUrl:encodeURI(`${this.url}${data.signedURL}${(options === null || options === void 0 ? 0 : options.download) ? `&download=${options.download === !0 ? "" : options.download}` : ""}`)};
    ...
    createSignedUrls(paths, expiresIn, options) {
      return __awaiter(this, void 0, void 0, function*() {
        try {
          const data = yield (0,fetch_1.post)(this.fetch, `${this.url}/object/sign/${this.bucketId}`, {expiresIn, paths}, {headers:this.headers}), downloadQueryParam = (options === null || options === void 0 ? 0 : options.download) ? `&download=${options.download === !0 ? "" : options.download}` : "";
    ...
    exists(path) {
      return __awaiter(this, void 0, void 0, function*() {
        ...
        try {
          ...
          if ((0,errors_1.isStorageError)(error) && error instanceof errors_1.StorageUnknownError && (_path = error.originalError, [400, 404].includes(_path === null || _path === void 0 ? void 0 : _path.status))) {
            return {data:!1, error};
          }
          throw error;
        }
