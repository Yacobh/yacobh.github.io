...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12867){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12868,G__12869,seq12867__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12898_SHARP_){
return (!((cljs.core.meta(p1__12898_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12913__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12914){var _e__11812__auto__ = e12914;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e12916){var _e__11812__auto__ = e12916;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12918 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12919 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12919);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12920__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12918);
}});
...
var temp__5802__auto___12942 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12942)){
var managed_print_level_12943 = temp__5802__auto___12942;
var _STAR_print_level_STAR__orig_val__12922_12945 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12923_12946 = managed_print_level_12943;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12923_12946);
...
job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12922_12945);
}} else {
job_fn();
}
