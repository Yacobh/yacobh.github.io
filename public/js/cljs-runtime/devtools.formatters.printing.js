...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29379){
var G__29380 = cljs.core.first(seq29379);
var seq29379__$1 = cljs.core.next(seq29379);
var G__29381 = cljs.core.first(seq29379__$1);
var seq29379__$2 = cljs.core.next(seq29379__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29380,G__29381,seq29379__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29393_SHARP_){
return (!((cljs.core.meta(p1__29393_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29402__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29404){var _e__28210__auto__ = e29404;
return false;
}})();
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
...
}catch (e29406){var _e__28210__auto__ = e29406;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29413 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29414 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29414);
...
var map__29415 = opts;
var map__29415__$1 = cljs.core.__destructure_map(map__29415);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29415__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29413);
}});
...
var temp__5821__auto___29494 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5821__auto___29494)){
var managed_print_level_29495 = temp__5821__auto___29494;
var _STAR_print_level_STAR__orig_val__29421_29496 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29422_29497 = managed_print_level_29495;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29422_29497);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29420_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29420_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29421_29496);
}} else {
job_fn();
}
