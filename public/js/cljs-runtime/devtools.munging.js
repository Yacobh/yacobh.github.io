...
var o12451 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12451["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12452 = temp__5802__auto____$1;
return (o12452["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11779__auto__ = f;
return (o__11779__auto__["toString"]).call(o__11779__auto__);
} else {
return "";
}
}catch (e12457){var _ = e12457;
return "";
}});
...
try{var o__11779__auto___12776 = t;
(o__11779__auto___12776["cljs$lang$ctorPrWriter"]).call(o__11779__auto___12776,t,writer);
}catch (e12475){var __12777 = e12475;
}
...
var char_code = (function (){var o__11779__auto__ = (new String(char$));
return (o__11779__auto__["charCodeAt"]).call(o__11779__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11779__auto__ = String;
return (o__11779__auto__["fromCharCode"]).call(o__11779__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12489 = num_code;
switch (G__12489) {
case (1):
return (185);
...
var o__11779__auto__ = String;
return (o__11779__auto__["fromCharCode"]).call(o__11779__auto__,superscript_code);
});
/**
...
}catch (e12511){var _e__11812__auto__ = e12511;
return false;
}})())){
...
var vec__12516 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12516,(0),null);
...
var G__12793 = (i__5727__auto___12791 + (1));
i__5727__auto___12791 = G__12793;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12538){
var vec__12540 = p__12538;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12540,(0),null);
...
var G__12794 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12795 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12794;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12533){
...
var vec__12564 = cljs.core.split_with((function (p1__12561_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12561_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(1),null);
...
var vec__12575 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12575,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12575,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12802 = cljs.core.rest(remaining_tokens);
var G__12803 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12802;
name_tokens = G__12803;
continue;
} else {
...
var vec__12585 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12585,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12585,(1),null);
var vec__12588 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12588,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12588,(1),null);
var vec__12591 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12591,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12591,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12591,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12591,(3),null);
...
var vec__12609 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12616 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12616,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12616,(1),null);
var vec__12619 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12619,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12619,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12625 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12625) : devtools.munging.parse_fn_info_deep.call(null,G__12625));
})()));
}
} else {
return fn_info;
...
var G__12833 = (arity + (1));
var G__12834 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12642){
var vec__12647 = p__12642;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12647,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12647,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12692_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12692_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12693_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12693_SHARP_);
}),sorted_infos);
...
var G__12842 = (i__5727__auto___12838 + (1));
i__5727__auto___12838 = G__12842;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12697){
var vec__12698 = p__12697;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12698,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12694){
...
var map__12717 = options;
var map__12717__$1 = cljs.core.__destructure_map(map__12717);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12717__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12717__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12717__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12717__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12718 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12718,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12718,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12718,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12718,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12718,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12718,(5),null);
...
var o__11779__auto__ = f;
return (o__11779__auto__["getBasis"]).call(o__11779__auto__);
});
/**
...
}catch (e12726){var _e__11812__auto__ = e12726;
...
var G__12857 = (obj[cljs.core.first(path)]);
var G__12858 = cljs.core.rest(path);
obj = G__12857;
path = G__12858;
continue;
} else {
...
var _STAR_ = (function (accum,p__12742){
var vec__12743 = p__12742;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12743,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12743,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12750){
var vec__12751 = p__12750;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12751,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12751,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12751,(2),null);
...
var post_process = (function (p__12765){
var vec__12766 = p__12765;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12766,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12766,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12760_SHARP_){
return (obj[cljs.core.first(p1__12760_SHARP_)]);
}),sorted_matches);
