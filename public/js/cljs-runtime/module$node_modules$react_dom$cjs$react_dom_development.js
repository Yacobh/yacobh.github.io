        ...
        for (propKey in oldProps) {
          if (!newProps.hasOwnProperty(propKey) && oldProps.hasOwnProperty(propKey) && oldProps[propKey] != null) {
            if (propKey === "style") {
              ...
              propKey !== "dangerouslySetInnerHTML" && propKey !== "children" && propKey !== "suppressContentEditableWarning" && propKey !== "suppressHydrationWarning" && propKey !== "autoFocus" && (registrationNameDependencies.hasOwnProperty(propKey) ? current || (current = []) : (current = current || []).push(propKey, null));
            }
          }
        }
