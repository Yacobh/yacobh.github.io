...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34363 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34363(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_34374 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_34374(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_34377 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_34377(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_34380 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_34380(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34388 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34388(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34395 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34395(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__34349,callback){
var map__34350 = p__34349;
var map__34350__$1 = cljs.core.__destructure_map(map__34350);
var input = map__34350__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34350__$1,new cljs.core.Keyword(null,"code","code",1586293142));
