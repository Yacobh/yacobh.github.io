    ...
    invoke(functionName, options = {}) {
      ...
      return __awaiter(this, void 0, void 0, function*() {
        try {
          ...
          region && region !== "any" && (_headers["x-region"] = region);
          let body;
          ...
          return {data:responseType === "application/json" ? yield response.json() : responseType === "application/octet-stream" ? yield response.blob() : responseType === "text/event-stream" ? response : responseType === "multipart/form-data" ? yield response.formData() : yield response.text(), error:null};
        } catch (error) {
