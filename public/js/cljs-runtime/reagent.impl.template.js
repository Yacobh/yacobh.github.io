...
var G__23136 = o;
reagent.impl.template.goog$module$goog$object.set(G__23136,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__23155__i < G__23155__a.length) {G__23155__a[G__23155__i] = arguments[G__23155__i + 0]; ++G__23155__i;}
  args = new cljs.core.IndexedSeq(G__23155__a,0,null);
} 
return G__23154__delegate.call(this,args);};
G__23154.cljs$lang$maxFixedArity = 0;
G__23154.cljs$lang$applyTo = (function (arglist__23156){
var args = cljs.core.seq(arglist__23156);
...
var G__23137 = o;
reagent.impl.template.goog$module$goog$object.set(G__23137,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23157__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23157 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__23158__i = 0, G__23158__a = new Array(arguments.length -  0);
while (G__23158__i < G__23158__a.length) {G__23158__a[G__23158__i] = arguments[G__23158__i + 0]; ++G__23158__i;}
  args = new cljs.core.IndexedSeq(G__23158__a,0,null);
} 
return G__23157__delegate.call(this,args);};
G__23157.cljs$lang$maxFixedArity = 0;
G__23157.cljs$lang$applyTo = (function (arglist__23159){
var args = cljs.core.seq(arglist__23159);
return G__23157__delegate(args);
});
...
var G__23138 = props;
var G__23138__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23138,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23138);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23138__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23139 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23139,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23139;
}
})(),id_class);
...
var G__23140 = (cljs.core.count(argv) - first_child);
switch (G__23140) {
case (0):
...
var vec__23141 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23141,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23141,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23141,(2),null);
...
var temp__5808__auto___23161 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23161 == null)){
} else {
var key_23162 = temp__5808__auto___23161;
(jsprops.key = key_23162);
}
...
var temp__5808__auto___23163 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23163 == null)){
} else {
var key_23164 = temp__5808__auto___23163;
(jsprops.key = key_23164);
}
...
var temp__5808__auto___23165 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23165 == null)){
} else {
var key_23166 = temp__5808__auto___23165;
(jsprops.key = key_23166);
}
...
var temp__5808__auto___23171 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23171 == null)){
} else {
var key_23173 = temp__5808__auto___23171;
...
var temp__5808__auto___23178 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23178 == null)){
} else {
var key_23179 = temp__5808__auto___23178;
(jsprops.key = key_23179);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23144_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23144_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23145 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23145,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23145,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template23151 = (function (opts,id,fn_to_element,parse_fn,meta23152){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23151.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23153,meta23152__$1){
var self__ = this;
var _23153__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23151(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23152__$1));
}));

(reagent.impl.template.t_reagent$impl$template23151.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23153){
var self__ = this;
var _23153__$1 = this;
return self__.meta23152;
}));

(reagent.impl.template.t_reagent$impl$template23151.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23151.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23151.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23151.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23151.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23151.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23152","meta23152",-547202905,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23151.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23151.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23151");

(reagent.impl.template.t_reagent$impl$template23151.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template23151");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23151.
 */
reagent.impl.template.__GT_t_reagent$impl$template23151 = (function reagent$impl$template$__GT_t_reagent$impl$template23151(opts,id,fn_to_element,parse_fn,meta23152){
return (new reagent.impl.template.t_reagent$impl$template23151(opts,id,fn_to_element,parse_fn,meta23152));
});
...
return (new reagent.impl.template.t_reagent$impl$template23151(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
