...
var G__39664 = o;
reagent.impl.template.goog$module$goog$object.set(G__39664,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__39670 = o;
reagent.impl.template.goog$module$goog$object.set(G__39670,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__39671 = props;
var G__39671__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39671,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39671);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39671__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39672 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39672,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39672;
}
})(),id_class);
...
var G__39673 = (cljs.core.count(argv) - first_child);
switch (G__39673) {
case (0):
...
var vec__39674 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39674,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39674,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39674,(2),null);
...
var temp__5827__auto___39695 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___39695 == null)){
} else {
var key_39696 = temp__5827__auto___39695;
(jsprops.key = key_39696);
}
...
var temp__5827__auto___39698 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___39698 == null)){
} else {
var key_39699 = temp__5827__auto___39698;
(jsprops.key = key_39699);
}
...
var temp__5827__auto___39708 = reagent.impl.util.react_key_from_vec(argv);
...
var temp__5827__auto___39716 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___39716 == null)){
} else {
var key_39717 = temp__5827__auto___39716;
(jsprops.key = key_39717);
}
...
var temp__5827__auto___39719 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___39719 == null)){
} else {
var key_39720 = temp__5827__auto___39719;
(jsprops.key = key_39720);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39677_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39677_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39678 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39678,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39678,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template39684 = (function (opts,id,fn_to_element,parse_fn,meta39685){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39684.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39686,meta39685__$1){
var self__ = this;
var _39686__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39684(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta39685__$1));
}));

(reagent.impl.template.t_reagent$impl$template39684.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39686){
var self__ = this;
var _39686__$1 = this;
return self__.meta39685;
}));

(reagent.impl.template.t_reagent$impl$template39684.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39684.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39684.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template39684.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39684.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39684.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta39685","meta39685",849582892,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39684.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39684.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39684");

(reagent.impl.template.t_reagent$impl$template39684.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template39684");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39684.
 */
reagent.impl.template.__GT_t_reagent$impl$template39684 = (function reagent$impl$template$__GT_t_reagent$impl$template39684(opts,id,fn_to_element,parse_fn,meta39685){
return (new reagent.impl.template.t_reagent$impl$template39684(opts,id,fn_to_element,parse_fn,meta39685));
});
...
return (new reagent.impl.template.t_reagent$impl$template39684(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
