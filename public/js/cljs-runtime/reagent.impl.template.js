...
var G__23442 = o;
reagent.impl.template.goog$module$goog$object.set(G__23442,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__23462.cljs$lang$applyTo = (function (arglist__23465){
...
var G__23443 = o;
reagent.impl.template.goog$module$goog$object.set(G__23443,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__23470__i < G__23470__a.length) {G__23470__a[G__23470__i] = arguments[G__23470__i + 0]; ++G__23470__i;}
  args = new cljs.core.IndexedSeq(G__23470__a,0,null);
} 
...
var G__23444 = props;
var G__23444__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23444,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23444);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23444__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23445 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23445,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23445;
}
})(),id_class);
...
var G__23446 = (cljs.core.count(argv) - first_child);
switch (G__23446) {
case (0):
...
var vec__23447 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23447,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23447,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23447,(2),null);
...
var temp__5808__auto___23480 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23480 == null)){
} else {
var key_23481 = temp__5808__auto___23480;
(jsprops.key = key_23481);
}
...
var temp__5808__auto___23484 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23484 == null)){
} else {
var key_23485 = temp__5808__auto___23484;
(jsprops.key = key_23485);
}
...
var temp__5808__auto___23490 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23490 == null)){
} else {
var key_23492 = temp__5808__auto___23490;
(jsprops.key = key_23492);
}
...
var temp__5808__auto___23493 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23493 == null)){
} else {
var key_23494 = temp__5808__auto___23493;
(jsprops.key = key_23494);
}
...
var temp__5808__auto___23500 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23500 == null)){
} else {
var key_23501 = temp__5808__auto___23500;
(jsprops.key = key_23501);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23450_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23450_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23451 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23451,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23451,(1),null);
...
break;
default:
var G__23504 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23505 = compiler;
v = G__23504;
compiler = G__23505;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template23457 = (function (opts,id,fn_to_element,parse_fn,meta23458){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23457.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23459,meta23458__$1){
var self__ = this;
var _23459__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23457(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23458__$1));
}));

(reagent.impl.template.t_reagent$impl$template23457.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23459){
var self__ = this;
var _23459__$1 = this;
return self__.meta23458;
}));

(reagent.impl.template.t_reagent$impl$template23457.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23457.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23457.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23457.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23457.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23457.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23458","meta23458",-247434437,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23457.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23457.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23457");

(reagent.impl.template.t_reagent$impl$template23457.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template23457");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23457.
 */
reagent.impl.template.__GT_t_reagent$impl$template23457 = (function reagent$impl$template$__GT_t_reagent$impl$template23457(opts,id,fn_to_element,parse_fn,meta23458){
return (new reagent.impl.template.t_reagent$impl$template23457(opts,id,fn_to_element,parse_fn,meta23458));
});
...
return (new reagent.impl.template.t_reagent$impl$template23457(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
