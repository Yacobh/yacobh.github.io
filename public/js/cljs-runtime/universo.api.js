goog.provide('universo.api');
universo.api.battery_status_component = (function universo$api$battery_status_component(){
...
universo.api.update_battery_status = (function universo$api$battery_status_component_$_update_battery_status(battery){
...
universo.api.setup_battery_listeners = (function universo$api$battery_status_component_$_setup_battery_listeners(battery){
universo.api.update_battery_status(battery);
...
return navigator.getBattery().then(universo.api.setup_battery_listeners).catch((function (p1__12007_SHARP_){
return console.error("Error accediendo a la API de bater\u00EDa:",p1__12007_SHARP_);
}));
} else {
return null;
}
...
)))], null)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),["Estado: ",(cljs.core.truth_(new cljs.core.Keyword(null,"charging","charging",-72750460).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(battery_state)))?"Cargando":"Descargando")].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),["Tiempo de carga restante: ",(cljs.core.truth_(new cljs.core.Keyword(null,"charging","charging",-72750460).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(battery_state)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"chargingTime","chargingTime",-1353766724).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(battery_state)))," segundos"].join(''):"N/A")].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),["Tiempo de descarga restante: ",((cljs.core.not(new cljs.core.Keyword(null,"charging","charging",-72750460).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(battery_state))))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"dischargingTime","dischargingTime",1190357238).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(battery_state)))," segundos"].join(''):"N/A")].join('')], null)], null)], null);
})], null));
});

//# sourceMappingURL=universo.api.js.map
