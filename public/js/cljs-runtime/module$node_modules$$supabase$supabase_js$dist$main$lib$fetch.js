shadow$provide.module$node_modules$$supabase$supabase_js$dist$main$lib$fetch = function(global, require, module, exports) {
  ...
  exports.resolveFetch = customFetch => {
    let _fetch;
    _fetch = customFetch ? customFetch : typeof fetch === "undefined" ? node_fetch_1.default : fetch;
    return (...args) => _fetch(...args);
  };
  exports.resolveHeadersConstructor = () => typeof Headers === "undefined" ? node_fetch_1.Headers : Headers;
  exports.fetchWithAuth = (supabaseKey, getAccessToken, customFetch) => {
    ...
    return (input, init) => __awaiter(void 0, void 0, void 0, function*() {
      ...
      _a = new HeadersConstructor(init === null || init === void 0 ? void 0 : init.headers);
