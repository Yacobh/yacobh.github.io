...
var map__11983 = form_data;
var map__11983__$1 = cljs.core.__destructure_map(map__11983);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11983__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11983__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var errors = cljs.core.PersistentArrayMap.EMPTY;
var G__11984 = errors;
var G__11984__$1 = ((clojure.string.blank_QMARK_(name))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11984,new cljs.core.Keyword(null,"name","name",1843675177),"El nombre es requerido"):G__11984);
var G__11984__$2 = ((clojure.string.blank_QMARK_(message))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11984__$1,new cljs.core.Keyword(null,"message","message",-406056002),"El mensaje es requerido"):G__11984__$1);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11984__$2,new cljs.core.Keyword(null,"email","email",1415816706),"Email inv\u00E1lido");
} else {
return G__11984__$2;
}
});
...
var G__11989 = cljs.core.deref(form_data);
var G__11990 = (function (){
return cljs.core.reset_BANG_(success,true);
});
return (on_submit.cljs$core$IFn$_invoke$arity$2 ? on_submit.cljs$core$IFn$_invoke$arity$2(G__11989,G__11990) : on_submit.call(null,G__11989,G__11990));
} else {
return cljs.core.reset_BANG_(errors,validation_errors);
}
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.grid-cols-1.md:grid-cols-2.gap-4.mb-4","div.grid.grid-cols-1.md:grid-cols-2.gap-4.mb-4",-1462072490),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-medium.text-gray-700.mb-1","label.block.text-sm.font-medium.text-gray-700.mb-1",602608273),"Nombre *"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.w-full.px-3.py-2.border.border-gray-300.rounded-md.focus:outline-none.focus:ring-2.focus:ring-blue-500","input.w-full.px-3.py-2.border.border-gray-300.rounded-md.focus:outline-none.focus:ring-2.focus:ring-blue-500",-982839672),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(form_data)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__11985_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form_data,cljs.core.assoc,new cljs.core.Keyword(null,"name","name",1843675177),p1__11985_SHARP_.target.value);
}),new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(errors)))?"border-red-500":null)], null)], null),(cljs.core.truth_(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(errors)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.text-red-500.text-sm.mt-1","p.text-red-500.text-sm.mt-1",1155243970),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(errors))], null):null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-medium.text-gray-700.mb-1","label.block.text-sm.font-medium.text-gray-700.mb-1",602608273),"Email (opcional)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.w-full.px-3.py-2.border.border-gray-300.rounded-md.focus:outline-none.focus:ring-2.focus:ring-blue-500","input.w-full.px-3.py-2.border.border-gray-300.rounded-md.focus:outline-none.focus:ring-2.focus:ring-blue-500",-982839672),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"email",new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"email","email",1415816706).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(form_data)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__11986_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form_data,cljs.core.assoc,new cljs.core.Keyword(null,"email","email",1415816706),p1__11986_SHARP_.target.value);
}),new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(new cljs.core.Keyword(null,"email","email",1415816706).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(errors)))?"border-red-500":null)], null)], null),(cljs.core.truth_(new cljs.core.Keyword(null,"email","email",1415816706).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(errors)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.text-red-500.text-sm.mt-1","p.text-red-500.text-sm.mt-1",1155243970),new cljs.core.Keyword(null,"email","email",1415816706).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(errors))], null):null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-4","div.mb-4",-1002350692),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-medium.text-gray-700.mb-1","label.block.text-sm.font-medium.text-gray-700.mb-1",602608273),"Tel\u00E9fono (opcional)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.w-full.px-3.py-2.border.border-gray-300.rounded-md.focus:outline-none.focus:ring-2.focus:ring-blue-500","input.w-full.px-3.py-2.border.border-gray-300.rounded-md.focus:outline-none.focus:ring-2.focus:ring-blue-500",-982839672),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"tel",new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"phone","phone",-763596057).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(form_data)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__11987_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form_data,cljs.core.assoc,new cljs.core.Keyword(null,"phone","phone",-763596057),p1__11987_SHARP_.target.value);
})], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-6","div.mb-6",-1954659128),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-medium.text-gray-700.mb-1","label.block.text-sm.font-medium.text-gray-700.mb-1",602608273),"Mensaje *"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea.w-full.px-3.py-2.border.border-gray-300.rounded-md.focus:outline-none.focus:ring-2.focus:ring-blue-500.h-24","textarea.w-full.px-3.py-2.border.border-gray-300.rounded-md.focus:outline-none.focus:ring-2.focus:ring-blue-500.h-24",-1203553690),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(form_data)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__11988_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form_data,cljs.core.assoc,new cljs.core.Keyword(null,"message","message",-406056002),p1__11988_SHARP_.target.value);
...
return universo.db.supabase.get_guestbook_entries().then((function (p1__11995_SHARP_){
cljs.core.reset_BANG_(entries,p1__11995_SHARP_);

return cljs.core.reset_BANG_(loading_entries_QMARK_,false);
})).catch((function (p1__11996_SHARP_){
console.error("Error loading guestbook:",p1__11996_SHARP_);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(entries,(function (p1__11997_SHARP_){
return cljs.core.vec(cljs.core.cons(new_entry,p1__11997_SHARP_));
}));
...
})).catch((function (p1__11998_SHARP_){
console.error("Error submitting:",p1__11998_SHARP_);
